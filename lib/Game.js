...
Game.prototype.update = function(){
	...
	var realCount = 0;
    for(var p in players){
        // console.log(players[p].name, players[p].socket);
    	realCount += players[p].getBallCount();
    }
    // console.log("BALL COUNT: "+realCount);
    // console.log(players.length,this.BalltoPlayerRatio,parseInt(players.length/this.BalltoPlayerRatio)+1);
