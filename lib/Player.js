...
Player.prototype.update = function(){
	...
	if((this.balls.length-this.hasMoneyBall == 0 || activeShield) && !AGGRESIVE_SCORE) this.score++;
	else if(AGGRESIVE_SCORE && activeShield) this.score += this.activeBoost.amt; //Lifetime - ballcount
	else if(AGGRESIVE_SCORE) this.score += this.activeBoost.amt - (this.balls.length-this.hasMoneyBall); //Lifetime - ballcount
